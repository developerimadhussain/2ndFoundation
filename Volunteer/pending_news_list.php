...
?>
        <div class="grid_10">
            ...
            <div class="box round first grid">
                <h2 class="page-header" style="color:deeppink" > PENDING NEWS LIST</h2>
                <div class="block"> 
                        ...
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                               ...
                               <?php
                                ...
                                $sql = "select * from news where user_id='$user_id' AND status='pending' ORDER BY created_date DESC ";
